...
(function (window) {
            ...
            homeDiv.innerHTML = `
                <div class="home_container">
                    ...
                    <p>
                        ...
                        I really <span class="green">sorry</span> for what happened. I never intended to hurt you. You're an awesome friend, and I value our friendship a lot.
                        <span class="green">bhai</span>.... <br/>
                        I care about U <span class="green">
                       
                       Hope you can forgive me and we can move past this<br/>
                        Sorry again, and I promise to do better!<br/>,
    ...
    navigationLink.click(nav => {
        ...
        if ($(this).hasClass('out')) {
            window.open('http://instagram.com/_code.with.yuvi_');
        } else {
            createHome();
        }
    });
